...
Completitud de los items: marcarlos como terminados con su fecha, el orden que las dependencias imponen para hacerlo, el congelamiento temporal de lo ya cerrado, la línea base contra la que se mide la desviación, cómo todo ello se lee en la parrilla del Gantt, y la realimentación del instante en que se marca.
