...
Configuración de la ventana temporal (fecha de inicio y duración) por roadmap, sustituyendo los valores hardcodeados del HTML original, con valores por defecto sensatos.
